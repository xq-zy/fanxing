      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
          <select name="auth_pid">
            ...
            <?php if(is_array($authinfo)): foreach($authinfo as $key=>$v): ?><option value="<?php echo ($v["auth_id"]); ?>"><?php echo str_repeat('&nbsp;',$v['level']*2); echo ($v["auth_name"]); ?></option><?php endforeach; endif; ?>
          </select>
        </div></td>
      </tr>
      <tr>
