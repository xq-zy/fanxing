          ...
          $.ajax({
              ...
              success:function (msg) {
                  if(msg.status ==200){
                      ...
                      layer.msg(msg.message);
                      setTimeout('window.location.href ="<?php echo U('Role/add');?>"',2000);
                  }
              }
          })
      })
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 权限管理 -> 添加角色</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show">
      <tr>
        <td height="20" bgcolor="#FFFFFF" class="STYLE6" width="500"><div align="right"><span class="STYLE19">角色名称：</span></div></td>
