...
-->
  ...
  <!--引入富文本编辑器的3个js文件-->
<script type="text/javascript" src="/Public/Public/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/Public/Public/ueditor/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/Public/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
      ...
      <tr>
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <a href="<?php echo U('Goods/index');?>">商品列表</a>   &nbsp; </span>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="general-tab-show">
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
          ...
          <img src="<?php echo ($info["goods_small_logo"]); ?>" alt="没有logo图片" />
        </div></td>
      </tr>
    </table>
...
<script type="text/javascript">
//页面加载完毕，就主动调用get_attr_info()使得类型和属性表单域对应都显示
$(function(){
  get_attr_info();
});
...
function del_pics(pics_id){
        ...
        <td colspan='100'>
          <ul>
            <?php if(is_array($picsinfo)): foreach($picsinfo as $key=>$v): ?><li style="list-style:none;float:left;" id="pics_show_<?php echo ($v["pics_id"]); ?>">
                <img src="<?php echo ($v["pics_mid"]); ?>" alt="" width="135" /><span style='color:red;cursor:pointer;'  class="delPics">[-]<input type="hidden" value="<?php echo ($v["pics_id"]); ?>" /></span>
  ...
  $(function () {
      $('.delPics').click(function () {
          var pics_id=$(this).find('input').val();
          layer.confirm('你确认要删除该相册吗？', {
              btn: ['确认','取消'] //按钮
          }, function(){
              del_pics(pics_id);
              layer.msg({
