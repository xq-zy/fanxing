...
<script type="text/javascript">
  $(function () {
      $('.delRole').click(function () {
          var role=$(this).parent().parent().parent().find('td:eq(2) div').html();
          var role_id=$(this).parent().parent().parent().find('td:eq(1) input').val();
          layer.confirm('你确认要移除角色：'+role, {
              btn: ['确认','取消'] //按钮
          }, function(){
              $.ajax({
                  url:'<?php echo U("Role/delRole");?>',
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 权限管理 -> 角色列表</span></td>
              </tr>
            </table></td>
            <td><div align="right"><span class="STYLE1">
              <a href="<?php echo U('Role/add');?>"><img src="/Public/Admin/images/add.gif" width="10" height="10" /> 添加角色</a>   &nbsp;
              </span>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">权限ids</span></div></td>
      ...
      <?php if(is_array($roleinfo)): foreach($roleinfo as $key=>$v): ?><tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($v["role_id"]); ?><input type="hidden" value="<?php echo ($v["role_id"]); ?>" /></span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
          <?php echo ($v["role_name"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
          <?php echo ($v["role_auth_ids"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">
          <?php echo ($v["role_auth_ac"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        <a href="<?php echo U('distribute',array('role_id'=>$v['role_id']));?>" style="color:rgb(59,99,117)">分配权限</a> |
        <a href="javascript:;" class="delRole" style='color:red;'>移除</a>
       </div></td>
