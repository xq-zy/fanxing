          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 权限管理 -> 修改管理员</span></td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
          <select name="role_id">
            ...
            <?php if(is_array($roleinfo)): foreach($roleinfo as $key=>$v): ?><option value="<?php echo ($v["role_id"]); ?>"  <?php if(($v["role_id"]) == $info["role_id"]): ?>selected='selected'<?php endif; ?>><?php echo ($v["role_name"]); ?></option><?php endforeach; endif; ?>
          </select>
        </div></td>
      </tr>
      <tr>
