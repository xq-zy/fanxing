...
<div class="list w1210 bc mt10">
	...
	<div class="list_bd fl ml10 mt10">
		...
		<div class="goodslist mt10">
			<ul>
<?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$v): ?><li>
	<dl>
		<dt><a href="<?php echo U('Goods/detail',array('goods_id'=>$v['goods_id']));?>" target="_blank"><img src="<?php echo ($v["goods_small_logo"]); ?>" alt="" /></a></dt>
		<dd><a href="<?php echo U('Goods/detail',array('goods_id'=>$v['goods_id']));?>" target="_blank"><?php echo ($v["goods_name"]); ?></a></dt>
		<dd><strong>商品价格：￥<?php echo ($v["goods_price"]); ?></strong></dt>
		<dd><strong>促销价格：￥<?php echo ($v["goods_members_price"]); ?></strong></dt>
