                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <div class="uclist mt10">
                            <ul class="list1 fl">
                                <li><a href="">用户信息></a></li>
                                <li><a href="<?php echo U('Order/showlist');?>">我的订单></a></li>
                                <li><a href="">收货地址></a></li>
                                <li><a href="">我的收藏></a></li>
                            </ul>
        ...
        <?php else: ?>
            ...
            <div class="navitems fl">
                <ul class="fl">
                    ...
                    <li><a href="">手机频道</a></li>
                    <li><a href="">家用电器</a></li>
                    <li><a href="<?php echo U('Goods/index');?>" target="_blank">品牌大全</a></li>
                    <li><a href="">团购</a></li>
                    <li><a href="">积分商城</a></li>
                    <li><a href="">夺宝奇兵</a></li>
                </ul>
	...
	<div class="goods_content fl mt10 ml10">
		...
		<div class="summary">
			...
			<div class="preview fl">
				<div class="midpic">
					<a href="<?php echo ($picsinfo[0]['pics_big']); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
						<img src="<?php echo ($picsinfo[0]['pics_mid']); ?>" alt="" />               <!-- 第一幅图片的中图 -->
					</a>
				</div>
...
<ul>
	<?php if(is_array($picsinfo)): foreach($picsinfo as $k=>$v): if(($k) == "0"): ?><li class="cur">
			<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($v["pics_mid"]); ?>',largeimage: '<?php echo ($v["pics_big"]); ?>'}"><img src="<?php echo ($v["pics_sma"]); ?>"></a>
			</li>
		<?php else: ?>
			<li>
			<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($v["pics_mid"]); ?>',largeimage: '<?php echo ($v["pics_big"]); ?>'}"><img src="<?php echo ($v["pics_sma"]); ?>"></a>
			...
			<div class="goodsinfo fl ml10">
				<ul>
					...
					<li class="market_price"><span>定价：</span><em>￥<?php echo ($goodsinfo['goods_price']); ?></em></li>
					<li class="shop_price"><span>会员价格：</span> <strong>￥<?php echo ($goodsinfo["goods_members_price"]); ?></strong> <a href="">(降价通知)</a></li>
